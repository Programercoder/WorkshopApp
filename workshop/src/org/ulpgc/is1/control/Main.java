...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Mechanic assigned for repair: "+repairManager.getMechanic().get(0).getRepair().get(0).getMechanicList().get(0).getName()+" "+repairManager.getMechanic().get(0).getRepair().get(0).getMechanicList().get(0).getSurname());
